    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join', models.ManyToManyField(blank=True, related_name='Member', through='join.JoinPass', to='join.team')),
            ],
        ),
        migrations.AddField(
            model_name='joinpass',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='join.member'),
        ),
        migrations.AddField(
            model_name='joinpass',
            name='team',
