...
urlpatterns = [
    path('myteam_notice/<int:myteam_id>',myteam_notice,name="myteam_notice"),
    path('myteam_log/<int:myteam_id>',myteam_log,name='myteam_log'),
    path('myteam_tactic/<int:myteam_id>',myteam_tactic,name='myteam_tactic'),
